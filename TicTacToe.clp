;; Solución análitica del juego Tic Tac Toe en CLIPS
...
(defrule medio-fila-columna-IZQ-1-2
	(declare (salience 6))
	?i <- (turno ia)
	(tablero (fila 2) (columna 2) (ficha ~v))
	(tablero (fila 1) (columna 2) (ficha x))
...
(defrule medio-fila-columna-DER-1-2
	(declare (salience 6))
	?i <- (turno ia)
	(tablero (fila 2) (columna 2) (ficha ~v))
	(tablero (fila 1) (columna 2) (ficha x))
...
(defrule medio-fila-columna-IZQ-2-1
	(declare (salience 6))
	?i <- (turno ia)
	(tablero (fila 2) (columna 2) (ficha ~v))
	(tablero (fila 3) (columna 2) (ficha x))
